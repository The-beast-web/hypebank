                            ...
                            <div class="nk-block-between">
                                <div class="nk-block-head-content">
                                    ...
                                    <div class="nk-block-des text-soft">
                                        <p>You have total {{ $kyc->count() }} kyc documents.</p>
                                    </div>
                                            ...
                                            @foreach ($users as $user)
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="nk-tb-col tb-col-md">
                                                        <span class="sub-text">{{ $user->kyc->phone }}</span>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-lg">
                                                        <span class="sub-text">{{ $user?->account_no }}</span>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-md">
                                                        <div class="icon-text">
                                                            <span class="sub-text">{{ $card->count() }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-xxl">
                                                        <span class="sub-text">{{ $user->kyc->created_at }}</span>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-lg">
                                                        <span
                                                            class="tb-status text-capitalize @if ($user->kyc->status == 'pending' || $user->kyc->status == 'declined') text-danger @endif @if ($user->kyc->status == 'approved') text-success @endif">
                                                            {{ $user->kyc->status }}
                                                        </span>
                                                    </div>
                                                    <div class="nk-tb-col nk-tb-col-tools">
                                                        <ul class="nk-tb-actions gx-1">
                                                            ...
                                                            @if ($user->kyc->status == 'pending' || $user->kyc->status == 'declined')
                                                                <li class="nk-tb-action-hidden">
                                                                    <a href="{{ route('admin.kyc.approve', $user->kyc->id) }}"
                                                            ...
                                                            @if ($user->kyc->status == 'approved')
                                                                <li class="nk-tb-action-hidden">
                                                                    <a href="{{ route('admin.kyc.cancel', $user->kyc->id) }}"
                                                                        class="btn btn-trigger btn-icon"
                                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                                        title="Cancel">
                                                            ...
                                                            @if ($user->kyc->status == 'pending')
                                                                <li class="nk-tb-action-hidden">
                                                                    <a href="{{ route('admin.kyc.decline', $user->kyc->id) }}"
                                                                        class="btn btn-trigger btn-icon"
                                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                                        title="Decline">
                                                                ...
                                                                <div class="drodown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <ul class="link-list-opt no-bdr">
                                                                            <li>
                                                                                <a
                                                                                    href="{{ route('admin.kyc.detail', $user->kyc->id) }}">
                                                                            ...
                                                                            @if ($user->kyc->status == 'pending' || $user->kyc->status == 'declined')
                                                                                <li>
                                                                                    <a
                                                                                        href="{{ route('admin.kyc.approve', $user->kyc->id) }}">
                                                                                        <em
                                                                            ...
                                                                            @endif
                                                                            @if ($user->kyc->status == 'approved')
                                                                                <li><a href="{{ route('admin.kyc.cancel', $user->kyc->id) }}">
                                                                                        <em
                                                                            ...
                                                                            @if ($user->kyc->status == 'pending')
                                                                                <li><a
                                                                                        href="{{ route('admin.kyc.decline', $user->kyc->id) }}">
                                                                                        <em class="icon ni ni-na"></em>
                                                                                        <span>Decline</span>
                                                                                    </a>
                                                                                </li>
