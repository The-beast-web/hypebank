                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Withdrawal Trash List</h3>
                                <div class="nk-block-des text-soft">
                                    <p>You have total {{ $withdraws->count() }} withdrawals trash.</p>
                                </div>
                                ...
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools g-3">
                                            <li><a href="{{ route('admin.withdraw.list') }}"
                                                    class="btn btn-white btn-outline-light" data-bs-toggle="tooltip"
                                                    data-bs-placement="bottom" title="User Withdrawal List"><em
                                                ...
                                                <div class="nk-tb-col nk-tb-col-tools">
                                                    <ul class="nk-tb-actions gx-1">
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{ route('admin.withdraw.trash.restore', $withdraw->id) }}"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body mt-3">
                                                            ...
                                                            <div><a class="btn btn-primary btn-block"
                                                                    href="{{ route('admin.withdraw.trash.delete.admin', $withdraw->id) }}"
                                                            ...
                                                            <div><a class="btn btn-light btn-block"
                                                                    href="{{ route('admin.withdraw.trash.delete.all', $withdraw->id) }}"
