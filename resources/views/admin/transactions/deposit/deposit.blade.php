                        ...
                        <div class="nk-block-head nk-block-head-sm">
                            <div class="nk-block-between">
                                <div class="nk-block-head-content">
                                    <h3 class="nk-block-title page-title">Users Deposit List</h3>
                                    <div class="nk-block-des text-soft">
                                        <p>You have total {{ $deposits->count() }} deposits.</p>
                                    </div>
                                    ...
                                    <div class="toggle-wrap nk-block-tools-toggle">
                                        ...
                                        <div class="toggle-expand-content" data-content="pageMenu">
                                            <ul class="nk-block-tools g-3">
                                                <li>
                                                    <a href="{{ route('admin.deposits.trash') }}"
                                                        class=" btn btn-icon btn-white btn-outline-light"
                                                        data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                        title="View Trash"><em class="icon ni ni-trash-fill"></em>
                                                        <span class="badge bg-danger rounded-pill">{{ $trash->count() }}</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="card-inner p-0">
                                        <div class="nk-tb-list nk-tb-ulist">
                                            <div class="nk-tb-item nk-tb-head">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><span class="sub-text">Deposit Method</span>
                                                </div>
                                            ...
                                            @foreach ($deposits as $deposit)
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="nk-tb-col">
                                                        <a href="html/customer-details.html">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">{{ $deposit->user->name }}</span>
                                                                </div>
                                                            </div>
                                                        </a>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-sm">
                                                        <span class="sub-text">{{ $deposit->user->email }}<span>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-md">
                                                        <span class="sub-text">{{ $deposit->payment_method }}</span>
                                                    </div>
                                                    ...
                                                    <div class="nk-tb-col tb-col-md">
                                                        <div class="icon-text">
                                                            <span class="sub-text">{{ $deposit->created_at }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-xxl">
                                                        <span
                                                            class="sub-text text-capitalize @if ($deposit->status == 'pending') text-danger @endif @if ($deposit->status == 'declined') text-danger @endif @if ($deposit->status == 'approved') text-success @endif">
                                                            {{ $deposit->status }}
                                                        </span>
                                                    </div>
                                                    ...
                                                    <div class="nk-tb-col nk-tb-col-tools">
                                                        <ul class="nk-tb-actions gx-1">
                                                            <li class="nk-tb-action-hidden">
                                                                <a href="{{ route('admin.deposits.details', $deposit->id) }}"
                                                                    class="btn btn-trigger btn-icon" data-bs-toggle="tooltip"
                                                                    data-bs-placement="top" title="View">
                                                                    <em class="icon ni ni-eye-fill"></em>
                                                                </a>
                                                            </li>
                                                            @if ($deposit->status == 'pending' || $deposit->status == 'declined')
                                                                <li class="nk-tb-action-hidden">
                                                            ...
                                                            @if ($deposit->status == 'approved')
                                                                <li class="nk-tb-action-hidden">
                                                                    <a href="{{ route('admin.deposits.cancel', $deposit->id) }}"
                                                                        class="btn btn-trigger btn-icon"
                                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                            ...
                                                            @endif
                                                            <li class="nk-tb-action-hidden">
                                                                <a href="{{ route('admin.deposits.delete', $deposit->id) }}"
                                                                    class="btn btn-trigger btn-icon" data-bs-toggle="tooltip"
                                                                ...
                                                                <div class="drodown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <ul class="link-list-opt no-bdr">
                                                                            ...
                                                                            @if ($deposit->status == 'pending' || $deposit->status == 'declined')
                                                                                <li><a
                                                                                        href="{{ route('admin.deposits.approve', $deposit->id) }}"><em
                                                                                            class="icon ni ni-check-circle"></em><span>Approve
                                                                                            Deposit</span></a></li>
                                                                            @endif
                                                                            @if ($deposit->status == 'approved')
                                                                                <li><a
                                                                                        href="{{ route('admin.deposits.cancel', $deposit->id) }}"><em
                                                                                            class="icon ni ni-cross-circle"></em><span>Cancel
                                                                                            Approval</span></a></li>
                                                                            @endif
                                                                            @if ($deposit->status == 'pending')
                                                                                <li><a
                                                                                        href="{{ route('admin.deposits.decline', $deposit->id) }}"><em
                                                                                            class="icon ni ni-na"></em><span>Decline
                                                                                            Deposit</span></a></li>
                                                                            @endif
                                                                            <li><a
                                                                                    href="{{ route('admin.deposits.delete', $deposit->id) }}"><em
                                        ...
                                        <div class="nk-block-between-md g-3">
                                            ...
                                            <div class="g">
                                                <div
                                                    ...
                                                    <div>Page {{ $deposits->currentPage() }} OF {{ $deposits->lastPage() }}</div>
                                                </div>
                                            </div><!-- .pagination-goto -->
                                        </div><!-- .nk-block-between -->
                                    </div><!-- .card-inner -->
