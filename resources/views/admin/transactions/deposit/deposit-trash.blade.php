                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Deposit Trash List</h3>
                                <div class="nk-block-des text-soft">
                                    <p>You have total {{ $deposits->count() }} deposit trash.</p>
                                </div>
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools g-3">
                                            <li><a href="{{ route('admin.deposits') }}"
                                                    class="btn btn-white btn-outline-light" data-bs-toggle="tooltip"
                                                    data-bs-placement="bottom" title="User Deposit List"><em
                                        ...
                                        @foreach ($deposits as $deposit)
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md">
                                                    <span
                                                        class="sub-text text-capitalize">{{ $deposit->payment_method }}</span>
                                                </div>
                                                ...
                                                <div class="nk-tb-col nk-tb-col-tools">
                                                    <ul class="nk-tb-actions gx-1">
                                                        <li class="nk-tb-action-hidden">
                                                            <a href="{{ route('admin.deposits.trash.restore', $deposit->id) }}"
                                                                class="btn btn-trigger btn-icon" data-bs-toggle="tooltip"
                                                                data-bs-placement="top" title="Restore">
                                                                <em class="icon ni ni-undo"></em>
                                                            </a>
                                                        </li>
                                                        <li class="nk-tb-action-hidden" data-bs-toggle="modal"
                                                            data-bs-target="#modalDefault">
                                                            <div class="btn btn-trigger btn-icon" data-bs-toggle="tooltip"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body mt-3">
                                                            ...
                                                            <div><a class="btn btn-primary btn-block"
                                                                    href="{{ route('admin.deposits.trash.delete.admin', $deposit->id) }}"
                                                                    onclick="return(confirm('Permanently delete this item for Admin?'))">Delete
                                                                    for Admin Only</a>
                                                            </div>
                                                            </p>
                                                            <p>
                                                            <div><a class="btn btn-light btn-block"
                                                                    href="{{ route('admin.deposits.trash.delete.all', $deposit->id) }}"
                                                                    onclick="return(confirm('Permanently delete this item for Admin and User?'))">Delete
                                                                    for Admin
                                                                    and User</a></div>
                                                            </p>
                                                        </div>
