                        ...
                        <div class="nk-block-head nk-block-head-sm">
                            <div class="nk-block-between">
                                <div class="nk-block-head-content">
                                    <h3 class="nk-block-title page-title">Card Requests</h3>
                                    <div class="nk-block-des text-soft">
                                        <p>You have total {{ $cards->count() }} request(s).</p>
                                    </div>
                                    ...
                                    <div class="card-inner p-0">
                                        <div class="nk-tb-list nk-tb-ulist">
                                            <div class="nk-tb-item nk-tb-head">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><span class="sub-text">Card Type</span></div>
                                                <div class="nk-tb-col tb-col-lg"><span class="sub-text">Card PIN</span></div>
                                                <div class="nk-tb-col tb-col-md"><span class="sub-text">Other Cards</span>
                                                </div>
                                            ...
                                            @foreach ($cards as $card)
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="nk-tb-col tb-col-md">
                                                        <span class="sub-text text-capitalize">{{ $card->card_type }}</span>
                                                    </div>
                                                    ...
                                                    <div class="nk-tb-col tb-col-lg">
                                                        <span
                                                            class="tb-status text-capitalize @if ($card->status == 'pending') text-danger @endif @if ($card->status == 'approved') text-success @endif">{{ $card->status }}</span>
                                                    </div>
                                                    <div class="nk-tb-col nk-tb-col-tools">
                                                        <ul class="nk-tb-actions gx-1">
                                                            @if ($card->status == 'pending')
                                                                <li class="nk-tb-action-hidden">
                                                                    <a href="{{ route('admin.card.approve', $card->id) }}"
                                                                ...
                                                                <div class="drodown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <ul class="link-list-opt no-bdr">
                                                                            @if ($card->status == 'pending')
                                                                                <li><a href="#"><em
                                                                                            class="icon ni ni-check-circle"></em><span>Approve</span></a>
                                                                                </li>
                                                                            @endif
                                                                            @if ($card->status == 'approved')
                                                                                <li><a href="#"><em
                                                                                            class="icon ni ni-na"></em><span>Decline</span></a>
                                                                                </li>
                                                                            @endif

                                                                            <li><a href="#"><em
                                                                                        class="icon ni ni-cross-fill-c"></em><span>Delete</span></a>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
