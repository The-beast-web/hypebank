                            ...
                            <tr>
                                <td style="text-align:center;padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 15px; color: #526484; font-size: 16px;">Your
                                        &#8358;{{ $content }} withdrawal approval has been cancelled due to
                                        verification issues and has been refunded to your balance. You will be
                                        notified when the problem is rectified and your withdrawal will be approved.</p>
