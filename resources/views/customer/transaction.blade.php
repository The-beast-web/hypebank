                            ...
                            <div class="nk-block-between">
                                <div class="nk-block-head-content">
                                    ...
                                    <div class="nk-block-des text-soft">
                                        <p>You have {{ $trans->count() }} total transaction(s).</p>
                                    </div>
                                            ...
                                            @foreach ($trans as $t)
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="nk-tb-col tb-col-md">
                                                        <span class="sub-text">{{ $t->created_at }}</span>
                                                    </div>
                                                
                                                        <div class="nk-tb-col tb-col-md">
                                                            <span
                                                                class="sub-text text-capitalize @if ($t?->status == 'pending' || $t?->status == 'declined') text-danger @endif @if ($t?->status == 'approved') text-success @endif">{{ $t?->status }}</span>
                                                        </div>
