                        ...
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                ...
                                <div class="nk-block-des text-soft">
                                    <p>You have {{ $count->count() }} total transaction(s).</p>
                                </div>
                            ...
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner p-0">
                                    <div class="nk-tb-list nk-tb-ulist">
                                        <div class="nk-tb-item nk-tb-head">
                                            ...
                                            <div class="nk-tb-col tb-col-sm"><span class="sub-text">Amount Involved</span>
                                            </div>
                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col">
                                                    <a href="html/customer-details.html">
                                                        <div class="user-card">
                                                            <div class="user-name">
                                                                <span class="tb-lead"> {{ $t->transaction_type }} <span
                                                ...
                                                <div class="nk-tb-col tb-col-sm">
                                                    <span class="sub-text">{{ $t->amount }}</span>
                                                </div>
                                                <div class="nk-tb-col tb-col-md">
                                                    <span
                                                        class="sub-text">{{ $t->created_at->toFormattedDateString() }}</span>
                                                </div>

                                                <div class="nk-tb-col tb-col-md">
                                                    <span
                                                        class="sub-text text-capitalize @if ($t?->status == 'approved' || $t?->status == 'successful') text-success @else text-danger @endif">{{ $t?->status }}</span>
                                                </div>
                                                ...
                                                <div class="nk-tb-col nk-tb-col-tools">
                                                    <ul class="nk-tb-actions gx-1">
                                                        ...
                                                        <li class="nk-tb-action-hidden">
                                                            ...
                                                            <a href="{{ route('customer.transaction.delete', $t->id) }}"
                                                                class="btn btn-trigger btn-icon" data-bs-toggle="tooltip"
                                ...
                                <div class="card-inner">
                                    <div class="nk-block-between-md g-3">
                                        <div class="g">
                                            {!! $trans->links('paginators.custom') !!}
                                        </div>
                                        <div class="g">
                                            <div
                                                class="pagination-goto d-flex justify-content-center justify-content-md-start gx-3">
                                                <div>Page {{ $trans->currentPage() }} OF {{ $trans->lastPage() }}</div>
                                            </div>
                                        </div><!-- .pagination-goto -->
                                    </div><!-- .nk-block-between -->
                                </div><!-- .card-inner -->
