                                ...
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools g-3">
                                            <li><a href="{{ route('customer.loan') }}" class="btn btn-white btn-outline-light"><em
                                    ...
                                    <div class="card card-bordered pricing">
                                        ...
                                        <div class="pricing-body">
                                            <ul class="pricing-features">
                                                <li><span class="w-50">Max Amount</span> - <span
                                                    class="ms-auto">{{ $loan->max_amount }} NGN</span>
                                            </li>
                                                <li><span class="w-50">Min Amount</span> - <span
                                                        class="ms-auto">{{ $loan->min_amount }} NGN</span>
                                                </li>
                                                <li><span class="w-50">EMI Type</span> - <span class="ms-auto">
                                                        {{ $loan->emi_type }}</span>
                                                </li>
                                                <li><span class="w-50">Loan Tenure</span> - <span class="ms-auto">Max
                                                        {{ $loan->tenure }} year(s)</span></li>
                                                <li><span class="w-50">Interest Rates</span> - <span
                                                        class="ms-auto">{{ $loan->interest_rates }}</span></li>
                                            </ul>
                                            <ul class="pricing-action">
                                                <li>
                                                    <a href="{{ route('customer.loan.readmore', [$loan->id, $loan->name]) }}"
