        ...
        <div class="nk-sidebar-content">
            <div class="nk-sidebar-menu" data-simplebar>
                <ul class="nk-menu">
                    ...
                    <li class="nk-menu-item @if(request()->routeIs('transfer')) active current-page @endif">
                        <a href="{{ route('transfer') }}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-coins"></em></span>
                            <span class="nk-menu-text">Transfer</span>
                        </a>
                    </li><!-- .nk-menu-item -->
                    <li class="nk-menu-item @if(request()->routeIs('transaction')) active current-page @endif">
                        <a href="{{ route('transaction') }}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-tranx"></em></span>
                            <span class="nk-menu-text">Transactions</span>
                        </a>
                    </li><!-- .nk-menu-item -->
                    <li class="nk-menu-item @if(request()->routeIs('card')) active current-page @endif">
                        <a href="{{ route('card') }}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-cards-fill"></em></span>
                            <span class="nk-menu-text">Cards</span>
                        </a>
                    </li><!-- .nk-menu-item -->
                    <li class="nk-menu-item @if(request()->routeIs('loan')) active current-page @endif">
                    ...
                    <li class="nk-menu-item">
                        <a href="html/ecommerce/integration.html" class="nk-menu-link">
                            ...
                            <span class="nk-menu-text">Online Payment</span>
                        </a>
                    </li>
                    <li class="nk-menu-item">
